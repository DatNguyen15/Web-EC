        ...
        <div className="col-4 final-col">
          <div className="chilren">
            ...
            <div class="guarantee">
              <ul>
                <li>
                  <i class="fas fa-check"></i> Bảo hành chính hãng 24 tháng tại
                  các TTBH Asus trên toàn quốc.{" "}
                </li>
                <li>
                ...
                <li>
                  <i class="fas fa-check"></i> Giảm giá 10% khi mua Gaming Gear.
                </li>
                <li>
                ...
                <li>
                  <i class="fas fa-check"></i> Trả góp 0% bằng thẻ tín dụng qua
                  M-Pos. Chi tiết.
                </li>
                <li>
                ...
                <li>
                  <i class="fas fa-check"></i> Linh kiện nâng cấp bảo hành theo
